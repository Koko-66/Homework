            ...
            while n < 2:
                ...
                while increase_budget not in ['y', 'n']:
                    increase_budget = input(
                        "You cannot afford this item. Can you increase your budget? y/n ").lower()
                    continue
                if increase_budget == 'n':
                    ...
                    if value > customer_budget:
                        n += 1
                        print(
                            f"Your budget is increased to £{customer_budget}, but it still not enough.")
                        continue
                    else:
                        print(f"Here’s your {item}")
                        break
            raise TooManyAttempts(
                "You tried too many times, try again later.")
